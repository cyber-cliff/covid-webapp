...
class HealthFacility(models.Model):
    ...
    covid_capacity = models.BooleanField(choices=TRUE_FALSE_CHOICES, blank=True,null=True)
...
class Patient(models.Model):
    ...
    overseas_travel = models.BooleanField(choices=TRUE_FALSE_CHOICES,blank=True,null=True)
    ...
    lab_confirmation_date = models.DateField(blank=True, null=True)
